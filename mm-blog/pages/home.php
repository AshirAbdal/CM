...
<div class="min-h-screen bg-[#f5f1e8] flex flex-col items-center justify-center px-6 text-center">
    ...
    <p class="text-xs uppercase tracking-[0.25em] text-tan-500 mb-4 font-sans">
    ...
    <a href="https://www.majesticmarquees.com"
       class="mt-8 text-sm uppercase tracking-widest text-forest-700 hover:text-tan-500 transition-colors font-sans">
        Visit Main Site
    </a>
</div>
