 ...
 * </body> (mirrors render_review_modal()). Hidden by default; consent.js
 * reveals Layer 1 on first visit and Layer 2 on request.
 */
        ...
        <div class="container-x py-5 sm:py-6 flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-8">
            <div class="min-w-0 lg:flex-1">
                ...
                <p class="text-body-s text-forest-700/85 mt-1 max-w-3xl">
                    We use cookies to run this website, keep our contact and quote forms secure, and to show our location map.
                    ...
                    Read our <a href="<?= e($cookiePolicy) ?>" class="spa-link underline hover:text-tan-500">Cookie Policy</a>.
                </p>
                <p class="text-body-s text-forest-700/55 mt-1 italic max-w-3xl">
                    Kami menggunakan cookie untuk menjalankan situs ini, menjaga keamanan formulir, dan menampilkan peta lokasi kami.
            ...
            <div class="relative w-full max-w-2xl bg-cream-50 rounded-2xl shadow-xl my-8 p-6 sm:p-8">
                ...
                <div class="mt-4">
                    ...
                    consent_category_row(
                        ...
                        'Required for the site to work and to keep forms secure (session, CSRF, anti-spam). Always active.',
                        'Diperlukan agar situs berfungsi dan formulir aman. Selalu aktif.',
                        true
                    );
                    consent_category_row(
                    ...
                    consent_category_row(
                        'location', 'Location map', 'Peta lokasi',
                        'Loads the interactive Google map on our Contact page.',
                        'Memuat peta Google interaktif di halaman Kontak kami.'
                    );
                    consent_category_row(
